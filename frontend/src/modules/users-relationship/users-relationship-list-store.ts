...
import usersRelationshipListExporterFields from '@/modules/users-relationship/users-relationship-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (
          !usersRelationshipListExporterFields ||
          !usersRelationshipListExporterFields.length
        ) {
          throw new Error(
            'usersRelationshipListExporterFields is required',
          );
        }
        ...
        const response = await UsersRelationshipService.list(
          filter,
          getters.orderBy,
          null,
          null,
