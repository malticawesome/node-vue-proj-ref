<template>
  <div style="display: flex;">
    ...
    ></el-button>
    <portal to="modal">
      <app-users-relationship-form-modal
...
<script lang="ts">
import UsersRelationshipFormModal from '@/modules/users-relationship/components/users-relationship-form-modal.vue';
import { UsersRelationshipPermissions } from '@/modules/users-relationship/users-relationship-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-users-relationship-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-users-relationship-form-modal': UsersRelationshipFormModal,
  },
