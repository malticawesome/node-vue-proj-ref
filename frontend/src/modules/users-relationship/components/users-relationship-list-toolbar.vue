<template>
  <div class="app-page-toolbar">
    <router-link
      :to="{ path: '/users-relationship/new' }"
    ...
    <router-link
      :to="{ path: '/users-relationship/import' }"
    ...
    <router-link
      :to="{
        path: '/audit-logs',
        query: { entityNames: 'usersRelationship' },
      }"
...
export default Vue.extend({
  name: 'app-users-relationship-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'usersRelationship/list/hasRows',
      loading: 'usersRelationship/list/loading',
      exportLoading: 'usersRelationship/list/exportLoading',
      selectedRows: 'usersRelationship/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'usersRelationship/list/doExport',
      doRemoveAllSelected:
        'usersRelationship/list/doRemoveAllSelected',
      doDisableAllSelected:
        'usersRelationship/list/doDisableAllSelected',
      doEnableAllSelected:
        'usersRelationship/list/doEnableAllSelected',
      doDestroyAll: 'usersRelationship/destroy/doDestroyAll',
    }),
