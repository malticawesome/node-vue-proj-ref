    ...
    >
      <el-row type="flex">
        <el-col :lg="12" :md="16" :sm="24">
          <el-form-item :label="fields.consultant.label" :prop="fields.consultant.name">
        ...
        <el-col :lg="12" :md="16" :sm="24">
          <el-form-item :label="fields.client.label" :prop="fields.client.name">
            <app-autocomplete-one-input
...
export default Vue.extend({
  name: 'app-users-relationship-list-filter',
  ...
  computed: {
    ...mapGetters({
      ...
      rawFilter: 'usersRelationship/list/rawFilter',
    }),
  ...
  methods: {
    ...mapActions({
      doReset: 'usersRelationship/list/doReset',
      doFetch: 'usersRelationship/list/doFetch',
    }),
