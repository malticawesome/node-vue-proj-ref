...
export default Vue.extend({
  name: 'app-log-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'log/list/hasRows',
      loading: 'log/list/loading',
      exportLoading: 'log/list/exportLoading',
      selectedRows: 'log/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'log/list/doExport',
      doRemoveAllSelected:
        'log/list/doRemoveAllSelected',
      doDisableAllSelected:
        'log/list/doDisableAllSelected',
      doEnableAllSelected:
        'log/list/doEnableAllSelected',
      doDestroyAll: 'log/destroy/doDestroyAll',
    }),
