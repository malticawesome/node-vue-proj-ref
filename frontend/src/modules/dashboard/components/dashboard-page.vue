  ...
  <div>
    <el-row type="flex" :gutter="16">
      <el-col :lg="8" :md="12" :sm="24">
        <app-dashboard-chart :config="bar" />
      </el-col>
      <el-col :lg="8" :md="12" :sm="24">
        <app-dashboard-chart :config="mix2" />
      </el-col>
      <el-col :lg="8" :md="12" :sm="24">
        <app-dashboard-chart :config="doughnut" />
      </el-col>
      <el-col :md="12" :sm="24">
        <app-dashboard-chart :config="mix1" />
      </el-col>
      <el-col :md="12" :sm="24">
        <app-dashboard-chart :config="radar" />
      </el-col>
      <el-col :lg="8" :md="12" :sm="24">
        <app-dashboard-chart :config="horizontalBar" />
      </el-col>
      <el-col :lg="8" :md="12" :sm="24">
        <app-dashboard-chart :config="polar" />
      </el-col>
      <el-col :lg="8" :md="12" :sm="24">
        <app-dashboard-chart :config="line" />
      </el-col>
    </el-row>

    <p class="dashboard-bottom-message">
      <app-i18n code="dashboard.message"></app-i18n>
    </p>
  </div>
</template>
