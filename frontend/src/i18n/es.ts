const es = {
  ...
  entities: {
    log: {
        ...
        label: 'Logs',
        menu: 'Logs',
        exporterFileName: 'exportacion_log',
        list: {
          menu: 'Logs',
          title: 'Logs',
        },
        create: {
          success: 'Log guardado con éxito',
        },
        update: {
          success: 'Log guardado con éxito',
        },
        ...
        destroyAll: {
          success: 'Log(s) eliminado con éxito',
        },
        edit: {
          title: 'Editar Log',
        },
    ...
    usersRelationship: {
        ...
        exporterFileName: 'exportacion_usersRelationship',
        list: {
          menu: 'UsersRelationships',
          title: 'UsersRelationships',
        },
        create: {
          success: 'UsersRelationship guardado con éxito',
        },
        update: {
          success: 'UsersRelationship guardado con éxito',
        },
        destroy: {
          success: 'UsersRelationship eliminado con éxito',
        },
        destroyAll: {
          success: 'UsersRelationship(s) eliminado con éxito',
        },
        edit: {
          title: 'Editar UsersRelationship',
        },
        fields: {
          id: 'Id',
        ...
        new: {
          title: 'Nuevo UsersRelationship',
        },
        view: {
          title: 'Ver UsersRelationship',
        },
        importer: {
          title: 'Importar UsersRelationships',
