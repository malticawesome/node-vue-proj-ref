const ptBR = {
  ...
  entities: {
    log: {
        ...
        label: 'Logs',
        menu: 'Logs',
        exporterFileName: 'Log_exportados',
        list: {
          menu: 'Logs',
          title: 'Logs',
        },
        create: {
          success: 'Log salvo com sucesso',
        },
        update: {
          success: 'Log salvo com sucesso',
        },
        ...
        destroyAll: {
          success: 'Log(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Log',
        },
        ...
        importer: {
          title: 'Importar Logs',
          fileName: 'log_template_importacao',
          hint:
    ...
    usersRelationship: {
        ...
        exporterFileName: 'UsersRelationship_exportados',
        list: {
          menu: 'UsersRelationships',
          title: 'UsersRelationships',
        },
        create: {
          success: 'UsersRelationship salvo com sucesso',
        },
        update: {
          success: 'UsersRelationship salvo com sucesso',
        },
        destroy: {
          success: 'UsersRelationship deletado com sucesso',
        },
        destroyAll: {
          success: 'UsersRelationship(s) deletado com sucesso',
        },
        edit: {
        ...
        new: {
          title: 'Novo UsersRelationship',
        },
        view: {
          title: 'Visualizar UsersRelationship',
        },
        importer: {
          title: 'Importar UsersRelationships',
          fileName: 'usersRelationship_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
